                ...
                <div className="lg:col-span-4 lg:sticky lg:top-32 self-start">
                    ...
                    >
                        ...
                        <a
                            ...
                            className="px-4 md:px-6 py-3 rounded-2xl bg-white border border-[#E5E5E5] text-[#171717] font-medium text-base md:text-lg hover:bg-gray-50 transition-all hover:shadow-sm whitespace-nowrap inline-flex items-center justify-center gap-2"
                        >
                            <WhatsAppIcon />
                            Contact us
                        </a>
