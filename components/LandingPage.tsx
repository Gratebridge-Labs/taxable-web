...
export default function LandingPage() {
    return (
        <div className="min-h-screen bg-white text-taxable-dark font-sans selection:bg-taxable-blue selection:text-white overflow-x-hidden">
            ...
            <motion.a
                href="https://wa.me/2349014833274"
                target="_blank"
                ...
                whileTap={{ scale: 0.9 }}
                className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:bg-[#20ba5a] transition-colors flex items-center justify-center group"
                aria-label="Chat on WhatsApp"
            >
                <WhatsAppIcon />
                <span className="ml-0 max-w-0 opacity-0 overflow-hidden whitespace-nowrap group-hover:max-w-xs group-hover:ml-2 group-hover:opacity-100 transition-all duration-500 ease-in-out font-medium text-sm">
                    Chat with us
                </span>
            </motion.a>
        </div>
